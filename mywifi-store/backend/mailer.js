...
async function sendOTPEmail(toEmail, name, otp, purpose = "verify") {
  ...
  const subject = isReset ? "Reset your MyWiFi Store password" : "Verify your MyWiFi Store account";
  const intro = isReset
    ? "We received a request to reset your password. Use the code below to continue:"
    : "Thanks for registering at MyWiFi Store. Use the code below to verify your email address:";
